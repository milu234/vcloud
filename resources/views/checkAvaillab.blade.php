...
<h1 class="add">StakeHolder</h1>
    ...
    <tr>
        ...
        <td>{{$item->spare}}</td>
        <td id="check"><a class="btn" style="background:#fc3;color:white;" href="/labR/send_request/{{$data[2]}}/{{$item->id}}">Send Request</a></td>
    </tr>  
@endforeach
...
@section('dashboard_name')
    Lab Assistant Request Check Availability
    @stop

    @section('Features')
    <ul id="side-main-menu" class="side-menu list-unstyled">                  
        {{-- <li><a href="{{ route('staffR') }}"> <i class=""></i>Back</a></li> --}}
        <li><a href="{{ route('labR') }}"> <i class=""></i>Back</a></li>
      </ul>
