    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <a href="/lab_as/request"><h5 class="sidenav-heading">Create Request</h5></a>
          <a href="/lab_as/history"><h5 class="sidenav-heading">History</h5>
            <a href="/lab_as/labcomponent"><h5 class="sidenav-heading">Lab Component</h5>
          @yield('Features')
